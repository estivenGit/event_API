...
namespace API
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<ILoggerService, SerilogLoggerService>();
            AccesoDatos.Container.Dependence.RegisterDependencies((interfaceType, implementationType) =>
            {
                container.RegisterType(interfaceType, implementationType);
            });
            LogicaNegocio.Container.Dependence.RegisterDependencies((interfaceType, implementationType) =>
            {
                container.RegisterType(interfaceType, implementationType);
            });
